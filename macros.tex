...
\newif\ifHideSolutions
  ...
  \newcommand{\examtitle}[2]{\noindent\vspace*{-\toppush}\newline\parbox{6.5in}
    {\textit{Introduction to Algorithms}\hfill#2\newline
      Massachusetts Institute of Technology \hfill 6.006 Spring 2021\newline
      %Singapore-MIT Alliance \hfill SMA5503\newline
...
% Fix {itemize} and {enumerate} within a {problems} environment to restore
% the default separation between bullets and items.  You used to need to use
% {normalitemize} and {normalenumerate} environments, which are still provided
% for backward compatibility, but you can now omit "normal".
\let\latexitemize=\itemize
\let\endlatexitemize=\enditemize
\renewenvironment{itemize}{\setlength{\labelsep}{0.5em}\begin{latexitemize}}
    {\end{latexitemize}}
\newenvironment{normalitemize}{\setlength{\labelsep}{0.5em}\begin{latexitemize}}
    {\end{latexitemize}}
\let\latexenumerate=\enumerate
\let\endlatexenumerate=\endenumerate
\renewenvironment{enumerate}{\setlength{\labelsep}{0.5em}\begin{latexenumerate}}
    {\end{latexenumerate}}
\newenvironment{normalenumerate}{\setlength{\labelsep}{0.5em}\begin{latexenumerate}}
    {\end{latexenumerate}}
